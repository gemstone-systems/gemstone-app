...
export const shardMessageSchema = websocketMessageSchema.safeExtend({
...
export const historyMessageSchema = websocketMessageSchema.safeExtend({
...
export const requestHistoryMessageSchema = websocketMessageSchema.safeExtend({
